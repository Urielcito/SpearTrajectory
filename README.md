# SpearTrajectory
- Removes all spread from using most ranged weapons (spears, javelins, bows)
- To compensate, revamps the entire accuracy system to give a better sense of difficulty when aiming, as opposed to just RNG applied in every shot
